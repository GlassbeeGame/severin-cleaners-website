        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-full text-2xl md:text-3xl font-black shadow-2xl hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
