...
const blogPosts = [
  ...
  {
    title: "Estate Cleanout Checklist: Complete Step-by-Step Guide",
    slug: "estate-cleanout-checklist",
    excerpt: "Compassionate guide for estate cleanouts. Learn how to sort belongings, coordinate donations, and manage the cleanout process with less stress.",
  ...
  {
    title: "What Items Can't Junk Removal Companies Take?",
    slug: "what-items-cant-be-removed",
    excerpt: "Not everything can be hauled away. Learn which items junk removal companies can't take due to safety regulations and environmental laws.",
    category: "FAQ",
    date: "2025-01-12",
    readTime: "5 min read",
    featured: false,
  ...
  {
    title: "Junk Removal vs Dumpster Rental: Which Saves Money?",
    slug: "junk-removal-vs-dumpster-rental",
    excerpt: "Compare costs, convenience, and hidden fees between junk removal services and dumpster rentals. Find out which option is right for your project.",
