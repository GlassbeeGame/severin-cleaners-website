        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Junk removal in San Diego costs $69 to $495 depending on item size and volume. Small items start at $69, standard items at $100, a 1/4 load costs $249, a 1/2 load costs $349, and a full trailer load costs $495. All prices include labor, hauling, disposal fees, and eco-friendly recycling."
            }
          },
          {
            "@type": "Question",
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-green-50 border-l-4 border-green-500 p-6 mb-8 rounded-r-lg">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Junk removal in San Diego costs <strong>starting at $69</strong> for small items, <strong>$100</strong> for standard items. Small items start at <strong>$69</strong>, standard items at <strong>$100</strong>, while a full trailer load costs <strong>$495</strong>. Pricing includes labor, hauling, disposal fees, and eco-friendly recycling.
                  </p>
                </div>
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-gray-700">Loading & hauling – From any location on your property</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
