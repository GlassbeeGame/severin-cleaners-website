      ...
      <main>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">
                Trusted by Homeowners & Businesses Across San Diego
              </h2>
              <p className="text-xl text-gray-600 mb-12 text-center">
                When emergencies strike, San Diego's top property managers, real estate agents, businesses, and homeowners trust our urgent junk hauling service to deliver professional results under pressure.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Property Managers</h3>
                  <p className="text-gray-600 text-sm">Emergency tenant cleanouts and urgent property maintenance</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Real Estate Agents</h3>
                  <p className="text-gray-600 text-sm">Last minute staging prep and pre-listing cleanouts</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Local Businesses</h3>
                  <p className="text-gray-600 text-sm">Commercial emergency cleanouts and equipment removal</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Family emergencies and urgent home cleanouts</p>
                </div>
              </div>
              ...
              <div className="mt-12 text-center">
                <div className="bg-white p-6 rounded-xl shadow-lg inline-block">
                  ...
                  <p className="text-gray-600">Based on 100+ emergency service reviews</p>
                </div>
              </div>
            </div>
          </div>
