        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Is there an extra cost for last minute or 24 hour junk removal service?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">What areas do you cover for 24 hour junk removal San Diego?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
              ...
              {openFAQ === 5 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    We provide 24 hour junk removal San Diego service throughout the entire county, from coastal areas like La Jolla and Pacific Beach to inland communities like El Cajon and Santee. Call to confirm immediate availability in your area.
                  </p>
                </div>
              )}
            </div>
