            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg mb-4">
                  Clearing a loved one's home is never easy. There's furniture to move, boxes to haul, appliances to dispose of—and you're dealing with it all while grieving or managing family logistics.
                </p>
