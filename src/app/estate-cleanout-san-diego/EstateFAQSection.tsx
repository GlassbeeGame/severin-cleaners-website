      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Answers to common questions about our estate junk hauling services.
          </p>
        </div>
              ...
              {openFAQ === 0 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    Estate cleanout costs depend on how much needs to be hauled away. Most full estates range from $1,500-$3,000 depending on property size and volume of items. Single trailer loads start at $175-$495. We provide written estimates after seeing what needs to be removed.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="bg-blue-50 rounded-xl p-8 mt-12 text-center">
          ...
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Call for a compassionate consultation about your estate cleanout needs.
          </p>
