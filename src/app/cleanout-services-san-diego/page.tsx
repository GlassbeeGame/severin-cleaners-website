              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                  <div className="bg-white rounded-lg shadow-md p-8">
                    ...
                    <p className="text-gray-700 mb-4">
                      We handle complete property cleanouts in <a href="/junk-removal-la-jolla" className="text-blue-600 hover:underline">La Jolla</a> property cleanouts, <a href="/junk-removal-pacific-beach" className="text-blue-600 hover:underline">Pacific Beach</a>, <a href="/junk-removal-chula-vista" className="text-blue-600 hover:underline">Chula Vista</a>, <a href="/junk-removal-el-cajon" className="text-blue-600 hover:underline">El Cajon</a>, <a href="/junk-removal-poway" className="text-blue-600 hover:underline">Poway</a>, <a href="/junk-removal-oceanside" className="text-blue-600 hover:underline">Oceanside</a>, <a href="/junk-removal-santee" className="text-blue-600 hover:underline">Santee</a>, and <a href="/la-mesa-junk-removal" className="text-blue-600 hover:underline">La Mesa</a>. Entire homes, estates, multi-unit buildings, and commercial spaces all receive professional service. Families settling estates trust us. Landlords use us for tenant turnovers. Realtors prepare homes for sale with our help.
                    </p>
                    <p className="text-gray-700 mb-4">
