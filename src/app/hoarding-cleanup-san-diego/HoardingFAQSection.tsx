              ...
              {openFAQ === 0 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    Costs vary based on volume. Single trailer loads range from $175-$495. Most hoarding cleanouts require multiple loads and typically cost $1,500-$5,000+ for complete removal. We provide free confidential consultations and written estimates.
                  </p>
                </div>
              )}
            </div>
