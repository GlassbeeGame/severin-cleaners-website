            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Best for: <a href="/junk-removal-santee" className="text-blue-600 hover:underline">Santee</a>, <a href="/junk-removal-la-mesa" className="text-blue-600 hover:underline">La Mesa</a>, <a href="/junk-removal-el-cajon" className="text-blue-600 hover:underline">El Cajon</a>, <a href="/junk-removal-lakeside" className="text-blue-600 hover:underline">Lakeside</a></p>
                </div>
