          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                No matter where you are in San Diego County, we're ready to help with professional junk removal services. Our local team knows every neighborhood and can navigate any location.
              </p>
            </div>
