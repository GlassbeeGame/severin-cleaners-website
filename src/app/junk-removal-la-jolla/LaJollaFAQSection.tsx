          ...
          <div className="space-y-4">
              ...
              {openFAQ === 0 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    Pricing varies by load size, access, and materials handled. We provide upfront, itemized quotes before work begins.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              {openFAQ === 1 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    Yes — all La Jolla jobs are handled with privacy and professionalism using unmarked trucks.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              {openFAQ === 2 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    Absolutely. We specialize in high-end furnishings, antiques, and fine art removal.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              {openFAQ === 3 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    Yes — we provide comprehensive estate cleanouts for large properties, families, and trustees.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">What eco-friendly disposal options do you offer?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
              ...
              {openFAQ === 4 && (
                <div className="px-6 py-4 bg-white">
                  <p className="text-gray-700 leading-relaxed">
                    We recycle, donate, and partner with luxury consignment services whenever possible to minimize waste.
                  </p>
                </div>
              )}
            </div>
