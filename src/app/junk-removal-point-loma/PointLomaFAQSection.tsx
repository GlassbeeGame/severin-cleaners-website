...
export default function PointLomaFAQSection() {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Frequently Asked Questions - Point Loma Junk Removal
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get answers to common questions about our professional <strong>Point Loma junk removal</strong> services,
            military PCS support, coastal property cleanouts, and Liberty Station service.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Do you provide junk removal for military PCS moves in Point Loma?</h3>
                <svg
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">How much does junk removal cost in Point Loma?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Do you handle coastal property cleanouts and storm debris?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Can you provide same-day junk hauling in Liberty Station or Sunset Cliffs?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Are your junk removal services eco-friendly and HOA-compliant?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
        ...
        <div className="bg-blue-50 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            Still Have Questions About Point Loma Service?
          </h3>
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Our military and coastal specialists are ready to answer any questions about our <strong>Point Loma junk removal</strong>
            services, provide free estimates, or schedule same-day service for your needs.
          </p>
