  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Scrap metal removal pricing is volume-based: Single Appliance starting at $175, 1/4 Trailer Load $249, 1/2 Trailer Load $349, Full Trailer Load $495. Large quantities of valuable metals (copper, aluminum, brass) may qualify for pricing credits. All prices include labor, transportation, and proper recycling disposal."
        }
      },
      {
        "@type": "Question",
