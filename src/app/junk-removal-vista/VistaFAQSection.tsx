...
export default function VistaFAQSection() {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get answers to common questions about our <strong>Vista junk removal</strong> services,
            commercial support, and eco-friendly North County disposal practices.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">How much does junk removal cost in Vista?</h3>
                <svg
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Do you handle apartment and condo junk hauling in Vista?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Can you provide same-day junk pickup in Vista?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <h3 className="font-bold text-gray-900 text-lg">Do you work with Vista businesses and warehouses?</h3>
                <svg
                  className={`w-5 h-5 text-gray-500 transition-transform ${
        ...
        <div className="bg-blue-50 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            Still Have Questions About Vista Junk Removal?
          </h3>
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Our experienced team is ready to answer any questions about our professional <strong>Vista junk removal</strong>
            services, provide detailed quotes, or schedule your same-day service for North County families and businesses.
          </p>
