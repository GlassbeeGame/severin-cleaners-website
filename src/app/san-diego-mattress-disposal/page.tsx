          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg mb-8">
                ...
                <ul className="space-y-3 text-gray-700 max-w-2xl mx-auto">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    Disposal in compliance with San Diego regulations
                  </li>
                  <li className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              ...
              <div className="bg-blue-50 p-8 rounded-xl mb-8">
                ...
                <p className="text-gray-700 text-center mb-4">
                  Need to remove box springs, bed frames, or other furniture along with your mattress? We can handle multiple items in one trip. If you're removing multiple furniture items, see our <a href="/couch-removal-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">couch removal</a> options. We also offer <a href="/furniture-removal-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">furniture removal</a>, <a href="/cleanout-services-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">full cleanout services</a>, and <a href="/foreclosure-eviction-cleanout-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">property cleanouts</a> across San Diego.
                </p>
