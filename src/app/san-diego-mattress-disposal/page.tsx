...
export const metadata: Metadata = {
  ...
  description: "Affordable mattress pickup in San Diego starting around $100. Same-day service, upfront pricing, and responsible recycling when possible. Call (619) 750-0114 today.",
  ...
  openGraph: {
    title: "San Diego Mattress Disposal & Pickup | Locally Owned Service",
    description: "Affordable mattress pickup in San Diego starting around $100. Same-day service, upfront pricing, and responsible recycling when possible.",
...
export default function MattressDisposalPage() {
  const serviceSchema = generateServiceSchema({
    ...
    description: "Professional mattress pickup and disposal services in San Diego. Same-day service available with responsible recycling and upfront pricing.",
    url: "https://severincleaners.com/san-diego-mattress-disposal",
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-xl mb-4 leading-relaxed">
                Need to get rid of an old mattress? Our locally owned <a href="/san-diego-junk-removal" className="text-blue-200 hover:text-white underline">San Diego junk removal</a> team makes it fast, easy, and affordable to dispose of mattresses the right way. We handle the heavy lifting, hauling, and recycling when possible — whether you&apos;re cleaning out a guest room, upgrading your bed, or clearing a <a href="/foreclosure-eviction-cleanout-san-diego" className="text-blue-200 hover:text-white underline">rental property</a>.
              </p>
              <p className="text-lg mb-8 text-blue-100">
                Locally Owned • Same-Day Pickup • Responsible Recycling When Possible
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-12 text-center">
                Fast, affordable, and eco-friendly mattress removal from a team that cares about our community and the environment.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Recycling When Possible</h3>
                  <p className="text-gray-600">We partner with local recycling facilities to responsibly dispose of mattresses and box springs</p>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-12 bg-blue-50 p-8 rounded-xl">
                <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">💚 Recycling & Donation</h3>
                <p className="text-gray-700 text-center mb-4">
                  Mattresses in good condition may be donated to local charities. Otherwise, we recycle materials like steel springs, foam, and wood through San Diego recycling partners whenever possible.
                </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-12 text-center">
                We care about keeping San Diego clean. That&apos;s why we prioritize eco-friendly disposal and recycling whenever possible. We offer the same <a href="/same-day-junk-removal-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">same-day service</a> for all our junk removal needs.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-8 rounded-xl">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">♻️ How We Recycle</h3>
                  <p className="text-gray-700 mb-4">
                    We work with local San Diego recycling facilities that break down old mattresses into reusable materials:
                  </p>
                ...
                <div className="bg-gray-50 p-8 rounded-xl">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">📋 Proper Disposal</h3>
                  <p className="text-gray-700 mb-4">
                    When recycling isn&apos;t an option, we ensure all mattresses are disposed of in compliance with San Diego County waste guidelines.
                  </p>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-center gap-3">
                      <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li className="flex items-center gap-3">
                      ...
                      Supporting San Diego&apos;s environmental goals
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section id="pricing" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold text-gray-900 mb-6 text-center">
                Transparent Mattress Disposal Pricing
              </h2>
              <p className="text-xl text-gray-600 mb-12 text-center">
                Mattress pickup typically starts around $100, depending on location, access, and total load size. Call for a quick quote — every price includes hauling, labor, and responsible disposal.
              </p>

              <div className="bg-white p-8 rounded-xl shadow-lg mb-8">
                <div className="text-center mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">Mattress Pickup</h3>
                  <p className="text-5xl font-bold text-blue-600 mb-2">Starting at $100</p>
                  <p className="text-gray-600">Exact pricing based on quantity and location</p>
                </div>
                <ul className="space-y-3 text-gray-700 max-w-2xl mx-auto">
                  <li className="flex items-center gap-3">
                    ...
                    All labor and heavy lifting included
                  </li>
                  <li className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    Hauling and transportation to disposal/recycling facility
                  </li>
                  <li className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    Recycling when possible through local partners
                  </li>
                  <li className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              ...
              <div className="bg-blue-50 p-8 rounded-xl mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">💰 Additional Items?</h3>
                <p className="text-gray-700 text-center mb-4">
                  Need to remove box springs, bed frames, or other furniture along with your mattress? We can handle multiple items in one trip. We also offer <a href="/furniture-removal-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">furniture removal</a>, <a href="/cleanout-services-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">full cleanout services</a>, and <a href="/foreclosure-eviction-cleanout-san-diego" className="text-blue-600 hover:text-blue-700 font-semibold underline">property cleanouts</a> across San Diego.
                </p>
                <p className="text-gray-600 text-center text-sm">
                  Volume-based pricing also available: 1/4 Load ($249), 1/2 Load ($349), Full Load ($495)
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mt-4 text-sm">We&apos;ll give you an exact total before we start — no surprises</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">
                Trusted San Diego Mattress Disposal Service
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-semibold">Mattress Removals Completed</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-semibold">San Diego County</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-br from-blue-900 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-blue-200 mt-6 text-lg">
              Available 7 Days a Week • Same-Day Service • Licensed & Insured • Eco-Friendly Disposal
            </p>
          </div>
        </section>
      </main>
